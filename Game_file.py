...
class SNAKE:
    def __init__(self):
        ...
        # self.crunch.sound = pygame.mixer.Sound('')
    ...
    # 3. snake head direction to update
...
class MAIN:
    ...
    def check_fail(self):
        # check if snake is outside of screen (x & y of head of snake)
    ...
    def draw_score(self):
        ...
        strawberry_rect = strawberry_img.get_rect(midright=(score_rect.left, score_rect.centery))
        bg_rect = pygame.Rect(strawberry_rect.left, strawberry_rect.top, (strawberry_rect.width + score_rect.width +6 ), strawberry_rect.height)
...
strawberry = pygame.image.load("graphics/fruit/strawberry.png").convert_alpha()
img_size = (45, 45)
# Scale the image to your needed size
strawberry_img = pygame.transform.scale(strawberry, img_size)
